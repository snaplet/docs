...
export function Editor() {
  ...
  const handleEditorDidMount = (_: editor.IStandaloneCodeEditor, monaco: Monaco) => {
  ...
  return (<div className="monaco-editor-block">
    ...
    }} height="57px" defaultLanguage="typescript" defaultValue="type Foo = 'bar'" onMount={handleEditorDidMount} />
  </div>)
}