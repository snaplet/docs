...
Attention all users: v0.74.0 has landed with significant changes you need to be aware of:

- **Preview Database Handling Overhaul** 💥  
  We've revamped how we handle preview databases. It's crucial that if you're utilizing this feature, you upgrade your CLI to the latest version to ensure compatibility and smooth operation.

This update is essential for maintaining the functionality of your preview databases. Please read the upgrade guide carefully before proceeding with the update.

We appreciate your understanding and cooperation as we continue to improve your experience.
