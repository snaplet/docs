...
<Steps>
<Step>
## November 2nd 2023 - v0.73.0

#### 🚨 Generate seeds change 🚨

We've made a change to the way Snaplet generates seeds.

We previously introduced a hash based on the plan's inputs to our seeding mechanism, but after many feedbacks, it's clear that it's not the right approach. We've decided to remove it and go back to the previous behavior.
The issue with this approach is that if you alter your plan, the modification will impact all the models involved in the plan.
