...
<Steps>
  ...
  #### 🚨 `@snaplet/seed` BREAKING CHANGES
  * The instantiation of the client is now async
  * Better compatibility with non-empty databases
  * New model callback API
  * Fix parent fields seed value
  * Inflection is turned on by default

  For more details, check out the [migration guide](/migrations/seed#from-0850-and-above).
  </Step>
  <Step>
