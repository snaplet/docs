...
> We drew significant inspiration from our friends at [Prisma](https://www.prisma.io/) in designing our client. If you're familiar with Prisma, using the Snaplet Data Client will feel incredibly intuitive and seamless.
...
- Generated data plays a critical role across different stages of software development.
- Snaplet Data Client simplifies data generation by deeply understanding your database schema.