...
<Step>
## 30 April 2024 - v0.97.10

#### Bugfixes
* For databases with no fields that can be used with Snaplet AI (e.g. if there were no text fields in the db, or if all the fields had non-composite unique constraints), users would be left waiting
  indefinitely for Snaplet AI to complete.
