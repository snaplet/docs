...
## From `0.80.0` and above

The `SnapletClient` is now stateful.

It means that a global seed is now incremented every time you call a function on the data client.
...
Also, everytime you call a model function, it returns the generated data as a store as well.
