...
Remember, a snapshot is just a static copy—it needs to be brought to life in a database, like your local development database, for you to start coding with it.

## Next Steps
For guidance on how to revive your snapshot into a working database, head over to our [restore guide](/core-concepts/restore).