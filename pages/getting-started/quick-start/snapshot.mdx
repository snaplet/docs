...
Snaplet allows you to generate production-like data using the [`generate`]((/getting-started/quick-start/generate)) feature, or create a snapshot from an existing production database. 
...
To learn how to modify your data transformations, including how to use [`@snaplet/copycat`](https://github.com/snaplet/copycat) to generate realistic, deterministic values, check out the [data transformation guide](/core-concepts/capture#select-data)
