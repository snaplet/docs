...
- You'll need a Snaplet account, and you'll need to have connected to your existing production database and captured a snapshot of it. If you're new to Snaplet, you can follow our [Getting Started](/getting-started/quick-start/snapshot) guide.
...
If you haven't previously created a snapshot at all, follow our [Getting Started](/getting-started/quick-start/snapshot) guide. Alternatively, you can follow along in the video guide below.
...
You'll need the Snaplet CLI to be installed and setup to restore your snapshot to Neon. If you haven't installed the Snaplet CLI, our [Getting Started](/getting-started/quick-start/snapshot) guide and our [Configuration](/reference/configuration) guide will take you through the process.
