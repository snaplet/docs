...
If you haven't previously created a snapshot at all, follow our [Getting Started](/snapshots/getting-started/quick-start) guide. Alternatively, you can follow along in the video guide below.
...
You'll need the Snaplet CLI to be installed and setup to restore your snapshot to Neon. If you haven't installed the Snaplet CLI, our [Getting Started](/snapshots/getting-started/quick-start) guide and our [Configuration](/reference/configuration) guide will take you through the process.
