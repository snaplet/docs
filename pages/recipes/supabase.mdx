...
During onboarding, the `select` option is automatically added to your config. In the web editor you will be shown a warning, if you choose to remove the `$default` field.
