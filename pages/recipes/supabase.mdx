...
> During the onboarding process, a base config will be generated for you. In that config all the schemas, except the `public` and `auth` schemas will be excluded. Learn more below.
