...
**3.2** Link your local development project to your Supabase project in the cloud.

```bash
supabase link --project-ref=<reference-id>
```

> Copy the project ref by navigating to your Supabase dashboard, clicking on "Settings", then copying the "Reference ID" in the "General settings" section.

**3.3.** Sync your local development database with your Supabase project in the cloud.

```bash
supabase db pull
```

**3.4.** Start your Supabase local stack. This will run the latest migrations against your local database.
...
⠹ Collecting information from your database
...
⠧ Generating assets for @snaplet/seed
```

> For this guide we assumed you have not linked your Snaplet account. To connect your account `snaplet auth setup` and follow the steps. 
