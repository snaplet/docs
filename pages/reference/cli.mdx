...
The `snaplet generate` command is used to populate an empty database with generated data.
...
| --output    | Write the sql statements to a file at the specified path           | string  |         |
