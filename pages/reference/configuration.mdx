...
For an in-depth guide on how to use the `select` section, check out the [Select data](/snapshots/core-concepts/capture#select-data) page.
...
For an in-depth guide on how to use the `transform` section, check out the [Transform data](/snapshots/core-concepts/capture#transform-data) page.
...
For an in-depth guide on how to use the `subset` section, check out the [Subset data](/snapshots/core-concepts/capture#subset-data) page.
