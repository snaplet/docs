...
If you don't have access to production data, or if you want to generate a fake dataset for development/testing purposes, you can use the `generate` section to define how Snaplet should generate your data.
...
For an in-depth guide on how to use the `generate` section, check out the [Generate data](/core-concepts/generate) page.
...
To generate your own types, use the `snaplet generate` command:
